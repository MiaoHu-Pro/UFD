...
class KGProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type, data_dir):
        ...
        # entity to text
        ent2text = {}
        # entity2text that is entity name : /m/07r1h --> Tom Cruise
        ...
        # entity2textlong that is entity description : /m/07r1h --> Tom Cruise, is an American film actor and producer. He has been nominated for three Academy Awards and......
...
def main():
    ...
    if args.do_train:
        ...
        # print("train_examples info: \n")
        # print("train_example",train_examples)
        # print("len(train_example)", len(train_examples)) # 521010, positive : negative = 1 : 5
        # time.sleep(10)
